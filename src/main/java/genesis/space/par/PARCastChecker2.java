...
public class PARCastChecker2 extends ManualTransformRule {
	
	public PARCastChecker2() {
		super();
		inside.add(sig(CtCodeElementImpl.class));
		vargens.put(1, new EnumerateGenerator(
				sig(CtExpressionImpl.class), // rootSig
				ImmutableSet.of(sig(CtVariableReadImpl.class), sig(CtFieldReadImpl.class), sig(CtInvocationImpl.class), 
						new MyNodeSig(BinaryOperatorKind.INSTANCEOF, false), sig(CtBinaryOperatorImpl.class)), // allowSigs
				3, // eleBound
